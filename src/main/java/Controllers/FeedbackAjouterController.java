...
public class FeedbackAjouterController {
    ...
    public void initialize() {
        try {
            // Pre-select the clientId in the ComboBox
            if (clientId > 0) {
                comboClientId.getSelectionModel().select(String.valueOf(clientId));
            }
    ...
    @FXML
    void ajouter() {
        // Remove this check since clientId is now passed automatically
        ...
        // Use the passed clientId instead of comboClientId.getValue()
